...
import { animateTextScroll, animatePatternBackground } from '../utils/gsapAnimations';
    ...
    <ReactLenis root>
      <main>
          <section className=' zoom-section bg-[#3dc1f0] text-white grid place-content-center h-screen sticky top-0 overflow-hidden'>
            ...
            <h1 className='bottom-to-top-text 2xl:text-7xl text-4xl/[1.2] md:text-6xl/[1.2] px-8 md:px-20 font-semibold text-center tracking-tight leading-[120%] z-10'>
              رحلتك للنجاح تبدأ من هنا
            </h1>
            <p className='bottom-to-top-text text-xl/8 px-4 md:px-80 text-center mt-6 z-10'>
